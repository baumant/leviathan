...
const DOWNLOADS = [
  ...
  {
    id: 'sfx.stinger.corporate',
    url: 'https://opengameart.org/sites/default/files/longscifisting_1.ogg',
    output: 'sfx/corporate-stinger.ogg',
  },
  {
...
const manifest = {
  ...
  assets: {
    ...
    'sfx.stinger.corporate': {
      src: '/audio/sfx/corporate-stinger.ogg',
      bus: 'sfx',
      volume: 0.64,
      playbackRate: 0.76,
    },
  ...
  music: {
    silent: [],
    intro: ['music.dread', 'ambience.deepRumble'],
    combat: ['music.dread', 'music.shanty'],
    corporate: ['music.dread', 'ambience.deepRumble'],
    victory: ['music.dread', 'music.shanty'],
    defeat: ['ambience.deepRumble'],
  },
  ...
  cues: {
    ...
    victory: ['vocal.whale.fin', 'music.dread'],
    defeat: ['sfx.stinger.corporate', 'ambience.deepRumble'],
  },
};
...
- "Long Sci-fi Sting" by Fupi, CC0, OpenGameArt: https://opengameart.org/content/long-sci-fi-sting
